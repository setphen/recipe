...
const withPrefix = (url: string) => url;

const createPlayroomLink = (code: string) => {
...
const TextWithIcon = ({children}: any) => (
  // setting this css variable is cheating. Don't do this at home kids.
  <EzLayout layout="cluster" alignX="center" style={{'--space-layout-gap': '4px'} as any}>
    {children}
  </EzLayout>
);
...
const CodeDemo = ({code, language, children}: any) => {
